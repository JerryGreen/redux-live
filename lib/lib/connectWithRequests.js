...
function connectWithRequests(requestsDeclaration) {
  ...
  return function (Component) {
    ...
    var mapDispatchToPropsWithDispatch = typeof mapDispatchToProps === 'function' ? function (dispatch) {
      return (0, _extends3.default)({}, mapDispatchToProps(dispatch), {
        dispatch: dispatch
      });
    } : null;
    ...
    // $FlowIgnore todo
    (0, _reactRedux.connect)(mapStateToPropsSelector, mapDispatchToPropsWithDispatch, mergeProps, (0, _extends3.default)({ forwardRef: true }, options)))(Component);
  };
}
    ...
    return _class2 = function (_React$Component) {
      ...
      (0, _createClass3.default)(WithRequests, [{
        ...
        value: function componentDidMount() {
          ...
          var oldWillUpdate = wrappedComponent.componentWillUpdate;
          // $FlowIgnore
          ...
          // $FlowIgnore flow bug
          var state = wrappedComponent.state;
        ...
        value: function componentWillUnmount() {
          ...
          // $FlowIgnore
          var dispatch = this.connectComponent.props.dispatch;
        ...
        value: function performRequest(requestKey) {
          ...
          if (request) {
            ...
            var _props = wrappedComponent.props,
                _state = wrappedComponent.state;

            dispatch((0, _extends3.default)({}, actionCreator(_props, _state), { requestKey: _requestKey }));
          } else {
